...
layout: template
filename: customtrackingcodetwotext.md
--- 
...
<script>
	...
	ap3c.cmd.push(function() {
		...
		ap3c.track({v: 0,  "ac" : [ {"fi": "str:cm:generic-text", "v": "firsttextmerge" }, {"fi": 'str:cm:1customfieldtextuser', 'v': "secondtextmerge"} ]});
	});
	var s, t; s = document.createElement('script'); s.type = 'text/javascript'; s.src = "https://static.ap3stg.com/capture/master/capture.js";
	t = document.getElementsByTagName('script')[0]; t.parentNode.insertBefore(s, t);
</script>

field: generic-text value: firsttextmerge
field: str:cm:1customfieldtextuser value: secondtextmerge
